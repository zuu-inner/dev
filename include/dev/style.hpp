...
inline std::string bold_text(std::string_view t)
{
    return styled(bold, t);
}
inline std::string dim_text(std::string_view t)
{
    return styled(dim, t);
}
inline std::string red_text(std::string_view t)
{
    return styled(red, t);
}
inline std::string green_text(std::string_view t)
{
    return styled(green, t);
}
inline std::string yellow_text(std::string_view t)
{
    return styled(yellow, t);
}
inline std::string cyan_text(std::string_view t)
{
    return styled(cyan, t);
}
inline std::string gray_text(std::string_view t)
{
    return styled(gray, t);
}
