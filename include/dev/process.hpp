...
inline int
spawn(const std::filesystem::path& executable, int argc, char* argv[], int arg_offset = 2)
{
    ...
    auto rc = _spawnv(_P_WAIT, exe_str.c_str(), const_cast<char* const*>(child_argv.data()));
